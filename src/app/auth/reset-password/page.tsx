...
import { validatePasswordWithStrength, validateConfirmPassword, type PasswordStrength } from "@/lib/validation"
...
export default function ResetPasswordPage() {
      ...
      <main className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5 flex items-center justify-center p-4">
        <div className="w-full max-w-md animate-fade-in">
          <div className="mb-8 text-center">
            <h1 className="text-balance text-3xl font-bold text-foreground mb-2">Invalid Reset Link</h1>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-accent/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md animate-fade-in">
        <div className="mb-8 text-center">
          <h1 className="text-balance text-3xl font-bold text-foreground mb-2">Reset Your Password</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            {passwordStrength && <ValidationFeedback strength={passwordStrength} />}
          </div>
