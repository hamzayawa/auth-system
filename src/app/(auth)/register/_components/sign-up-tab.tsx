...
export default function SignUpForm({
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			// Better Auth automatically creates a verification token
			// We construct the verification URL with the user's email
			// The backend should send the token via email
			try {
				const verificationUrl = `${window.location.origin}/auth/verify-email?token=PLACEHOLDER`;

				// Note: In a production setup, the backend should handle sending this email
				// This is a client-side fallback that may not work without proper token
