          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 min-w-[600px]">
            ...
            <div className="col-span-2 mt-6 bg-gray-50 -mx-6 -mb-6 p-6 rounded-b-xl">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="font-semibold">Explore all products</h3>
        ...
        <div className="relative">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 min-w-[500px]">
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-6">
                <div>
                  <h4 className="font-bold text-gray-800 mb-3">By Industry</h4>
                  <div className="grid gap-y-2">
                    <DropdownLink
                      icon={Globe}
                      name="SaaS"
      ...
      dropdownContent: (
        <div className="relative">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 border border-gray-200 min-w-[500px]">
            <div className="grid grid-cols-2 gap-8">
              <div>
                <h4 className="font-bold text-gray-800 mb-3">Documentation</h4>
                <div className="grid gap-y-2">
                  <DropdownLink
                    icon={Rocket}
                    name="Get Started"
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <Link href="/" className="text-black text-2xl font-bold ">
              <span className="font-hago text-xl">Yawa</span>
            </Link>
            {/* Desktop Navigation */}
            <div className="hidden lg:flex lg:items-center lg:space-x-6">
              {navItems.map((item) => (
                ...
                >
                  <Link
                    href={item.href}
                    className="text-black hover:text-gray-700 py-2 flex items-center gap-1"
                  >
                    {item.title}
